...
// const ButtonComponent = styled(FloatingActionButton)`
...
//   const getCheckedOutLabel = (data, user) => {
...
//     <FloatingActionButton raised={true} mini={true}>
...
//         <Dropdown floating trigger={<DropdownTrigger/>} direction='left' icon={null} upward={false}>
//           <Dropdown.Menu>
//             <Dropdown.Item>
//               <Link to={{
