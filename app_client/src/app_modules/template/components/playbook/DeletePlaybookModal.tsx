...
class DeletePlaybookModal extends React.Component<{}, IDeletePlaybookModalState> {
  constructor(props){
    super(props)
  ...
  public render() {
    ...
    return (
     <Modal
      ...
      size="small"
      trigger={
        <LeftActionButton size="large" onClick={this.open}>
    ...
    >
      <Modal.Content>
        ...
        <SoftBodyDiv>Are you sure you want to delete this Playbook Rule?</SoftBodyDiv>
      </Modal.Content>
      <Modal.Actions>
        <Button size="large" onClick={this.close}>Cancel</Button>
        <Button size="large" color="secondary">Delete</Button>
      </Modal.Actions>
    </Modal>
    )
  }
